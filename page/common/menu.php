...
$_MENU['glasses']['menu'][] = add_menu("조회 및 상담", "fa-list", BASE_URL."/page/glasses/inquiry/index.php");
$_MENU['glasses']['menu'][] = add_menu("관리", "fa-file-text-o", BASE_URL."/page/glasses/manage/index.php");
